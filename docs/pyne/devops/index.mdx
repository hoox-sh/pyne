...
| PyPI (`pyne`) | `.github/workflows/publish.yml` | [PyPI publish](/pyne/docs/devops/pypi-publish) |
| First ship / org transfer | GitHub org `hoox-sh` + Trusted Publishing | [Publish checklist](/pyne/docs/devops/publish-checklist) |
| Pro API containers | `Dockerfile` (targets api/api-dev/lsp), `docker-bake.hcl`, `docker-compose.yml` | [Docker](/pyne/docs/devops/docker) |
