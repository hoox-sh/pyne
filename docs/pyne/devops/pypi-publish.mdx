...
---
title: "PyPI publish"
description: "Ship hoox-pyne to PyPI via Trusted Publishing (OIDC). Import package stays pynescript."
---
...
> **Why not `pynescript` on PyPI?** That name is already owned by [elbakramer/pynescript](https://github.com/elbakramer/pynescript). Publishing under `hoox-pyne` avoids a name collision while keeping the code package id.
