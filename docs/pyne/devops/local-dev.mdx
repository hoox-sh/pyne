...
optional VS Code extension (Node). PyneTS is the standalone [hoox-sh/pynets](https://github.com/hoox-sh/pynets) / `@hoox-sh/pynets` package. The AXIS
charting PWA is a **sister repo** ([axis](https://github.com/hoox-sh/axis)) — do not recreate `frontend/` here.
...
flowchart LR
  ...
  TS[hoox-sh/pynets] --> BUN[bun test]
...
| [hoox-sh/pynets](https://github.com/hoox-sh/pynets) | Standalone TS library (`@hoox-sh/pynets`); not an in-tree submodule |
