...
Primary definition: [`.github/workflows/ci.yml`](https://github.com/hoox-sh/pyne/blob/main/.github/workflows/ci.yml). AXIS CI lives in the sister [axis](https://github.com/jango-blockchained/axis) repo. Release / PyPI builds are separate (`release.yml`, `publish.yml`).
