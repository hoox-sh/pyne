...
| --- | --- | --- |
| `pynescript-lsp` (PATH name; product CLI is `pyne-lsp`) | `langserver/__main__.py` | Editors / VSIX |
| `pynescript` (PATH name; product CLI is `pyne`) | `pynescript/__main__.py` | Shell / CI gates |
