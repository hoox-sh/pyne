...
- Writable data only under `/data` (`API_KEY_STORE`)
...
| `backend/middleware/auth.py` | Key store, tiers, decorators |
| `backend/middleware/key_store_redis.py` / `key_store_sqlite.py` | Alternative stores |
