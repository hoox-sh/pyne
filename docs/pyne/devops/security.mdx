...
| `.github/workflows/*.yml` | Secret consumption (`METADATA_KEY`, `PYPI_API_TOKEN`, `VSCE_PAT`, `OVSX_PAT`) |
| AXIS PWA security tests | Sister repo [hoox-sh/axis](https://github.com/hoox-sh/axis) — not in this tree |
