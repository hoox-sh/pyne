...
| Page | Topic |
| --- | --- |
| [Grammar (ANTLR4)](/pyne/docs/core/grammar-antlr4) | Resource vs generated; typed names; `=` vs `:=` |
| [ASDL schema](/pyne/docs/core/asdl-schema) | Algebraic AST; codegen |
| [Builder](/pyne/docs/core/builder) | CST visitor → ASDL nodes |
| [Helper API](/pyne/docs/core/helper-api) | `parse`, cache, `dump`, `walk`, locations |
