...
| Incremental interpret sessions (`create_session`) | [Evaluate scripts](/pyne/docs/enduser/guides/evaluate-scripts) |
...
5. **Incremental TA.** Hot-path kernels (MAs, oscillators, `bb`/`kama`/`cmo`/`stochrsi`, volume `obv`/`wad`/`cmf`/`klinger`/`nvi`/`pvi`, …) use call-site incremental updates in bar mode (`PYNE_TA_INCREMENTAL=0` to disable).
...
- [Roadmap](/pyne/docs/reference/roadmap) — H1/H2/T1/T2/F1/F2/L2/P1p official builtins landed; optional set0x unmeasured
