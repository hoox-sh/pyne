...
Residual dual-host gaps (seed conventions on some smoothers, Supertrend ratchet, ATR EMA-of-TR vs pure Wilder re-baseline) are tracked under [missing features](/pyne/docs/reference/missing-features)—not as silent “close enough” for the rows above.
