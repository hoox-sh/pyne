...
- **PyneTS** — TypeScript / Bun library. Standalone [hoox-sh/pynets](https://github.com/hoox-sh/pynets); PYNE consumes it only as the `pynets/` submodule. See [PyneTS](/pyne/docs/pynets).
