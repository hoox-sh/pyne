...
pyne parse-and-unparse strategy.pine --output-file strategy.pine.tmp \
...
```bash
set -e
pyne lint strategies/ --help  # note: single file PATH, not directory recursion
...
pyne parse-and-unparse strat.pine --output-file /tmp/s.pine
python - <<'PY'
