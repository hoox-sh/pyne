...
2. Open a **`.pyne`** (preferred for HOOX / PYNE stack sources), `.pine`, `.pinev5`, or `.pinev6` file — LSP activates when enabled. The VS Code extension also activates on `workspaceContains:**/*.{pyne,pine,…}`.
