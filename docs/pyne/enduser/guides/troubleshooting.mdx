...
Fix: activate the venv used for install; reinstall `pip install pyne` (import package is still `pynescript`).
...
| `ccxt` | `pip install "pyne[data]"`; exchange id; symbol `BTC/USDT` |
