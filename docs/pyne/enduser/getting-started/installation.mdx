...
- **License.** Package license is **LGPL-3.0-or-later** (`pyproject.toml`). Link dynamically against the library; respect LGPL obligations if you modify and redistribute.
