...
---
title: "End User Hub"
description: "Install PYNE (pip install pyne), run CLI/library eval with mode=auto, wire editors (.pyne/.pine), and call Pro API alerts + webhooks."
---
...
- **[Installation](/pyne/docs/enduser/getting-started/installation)** — PyPI **`pip install pyne`** (import `pynescript`), extras (`lsp`, `data`), Hatch checkout, smoke checks.
...
| --- | --- | --- |
| Install core | `pip install pyne` (import `pynescript`) | [Installation](/pyne/docs/enduser/getting-started/installation) |
| Install LSP | `pip install "pyne[lsp]"` | [Editors](/pyne/docs/enduser/guides/editors) |
| Install market data deps | `pip install "pyne[data]"` | [CLI data](/pyne/docs/enduser/guides/cli) |
