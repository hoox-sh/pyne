...
| --- | --- | --- |
| CLI | `pyne …` (alias `pynescript`) | One-shot parse, format, lint, market data, prewarm |
...
- **[CLI](/pyne/docs/enduser/guides/cli)** — `check`, `format`, `lint`, `compile`, `run`, `data`, …
...
| Bar-loop eval | `from pynescript.runtime import Runtime` | [Evaluate](/pyne/docs/enduser/guides/evaluate-scripts) |
...
| Path | Role |
| --- | --- |
| `src/pynescript/__main__.py` | Click CLI: check, format, lint, compile, run, data, … |
