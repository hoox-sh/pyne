...
Honesty over marketing: on scraped set01–04 corpora, **Runtime OK is ~94.3%** (parse is higher, ~99.96% after sanitize). Residual RUN_FAIL modes include intentional `runtime.error` library demos, missing multi-symbol data, and unsupported edge constructs—not a claim of 100% TradingView® parity. See [Compatibility](/pyne/docs/reference/compatibility).
