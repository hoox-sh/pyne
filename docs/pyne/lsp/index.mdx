...
flowchart TB
  ...
  subgraph LSP["pynescript-lsp (pygls)"]
...
Console scripts are separate: `pynescript` (Click CLI) vs `pynescript-lsp` (pygls). Do not conflate them — see [architecture](/pyne/docs/lsp/architecture).
