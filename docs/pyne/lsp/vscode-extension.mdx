...
description: "vscode-extension package: language id, TextMate grammar, LanguageClient wiring, settings, and VSIX build."
---
...
- **grammar:** `syntaxes/pinescript.tmLanguage.json` (`scopeName: source.pinescript`)
...
| `lsp.command` | `pynescript-lsp` | Server executable |
