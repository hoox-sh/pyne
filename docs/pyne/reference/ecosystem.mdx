...
| --- | --- |
| [hoox-sh/pyne](https://github.com/hoox-sh/pyne) | PYNE SoT (`hoox-pyne` **0.6.6**) |
...
6. **Do not** `npm install pynets` for this project. The published package is **`@hoox-sh/pynets`** from the standalone [hoox-sh/pynets](https://github.com/hoox-sh/pynets) repo. Python Runtime remains the oracle.
...
| Upload then keep running (Flask/VPS/container) | `PYNE_RUNNER=1` — [hosted runner](/pyne/docs/api/endpoints/runner) |
