...
Source distillations: `docs/compatibility_guarantee.md` (v1.2, 2026-08-03) and live test inventory. Metrics move as the suite grows — prefer CI and the [implementation status](/pyne/docs/reference/implementation-status) matrix for current checkmarks. Compatibility is **not** bit-identical TradingView® platform parity.
