...
description: "Known gaps and closed Pine Script™ v6 items — 0.6.0 parity increments (intraday risk, intrabar rollback, calendar timeframes, security barmerge, linter retirements); P1p corpus MISMATCH tail remains."
---
