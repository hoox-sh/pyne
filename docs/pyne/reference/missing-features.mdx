...
description: "Known gaps and closed Pine Script™ v6 items — H2/T1/F2/L2 shipped; corpus ~94.3%; foreign-na and plot parity harness landed."
---
...
| Corpus Runtime tail (**C1**) | ⚙️ ~**94.3%** set01–04 OK projected; PARSE stubs ~118; ~21 residual RUN_FAIL |
...
| set01–04 Runtime (baseline re-runs) | ~89.8% OK (≈2224/2477) |
| set01–04 Runtime (after C1 8-agent pass, projected) | **~94.3%** OK (≈2337/2477) |
