...
description: "Known gaps and closed Pine Script™ v6 items — 0.6.2 P1p official builtins 0 MISMATCH; 0.6.1 correctness follow-up on 0.6.0 parity (intraday risk, sessions, calendar timeframes, security barmerge, linter retirements)."
---
