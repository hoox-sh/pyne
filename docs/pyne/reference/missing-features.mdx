...
description: "Known gaps and closed Pine Script™ v6 items — 0.6.6 last-sample TA and convert/for-n safety; 0.6.5 convert-to-v6 UDF-safe prefixes; 0.6.4 convert-to-v6; 0.6.3 hosted runner; 0.6.2 P1p official builtins 0 MISMATCH."
---
