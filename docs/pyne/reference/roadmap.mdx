...
| PyPI **`hoox-pyne`** | ✅ live **0.6.7** ([pypi.org/project/hoox-pyne](https://pypi.org/project/hoox-pyne/)); CLIs `pyne` / `pyne-lsp` |
...
| pyne-worker 0.6.0 | ✅ edge `/run`; vendored engine is inconsistent (`__about__.py` **0.3.8**, dist-info **0.4.4**) and lags PyPI **0.6.7** |
