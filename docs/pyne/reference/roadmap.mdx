...
| PyPI **`hoox-pyne`** | ✅ live **0.3.11+** ([pypi.org/project/hoox-pyne](https://pypi.org/project/hoox-pyne/)); CLIs `pyne` / `pyne-lsp` |
...
| **T2** | Incremental TA for remaining heavy kernels | P2 | ✅ R7 + 0.3.10 volume inc + **0.3.11 nvi/pvi** |
