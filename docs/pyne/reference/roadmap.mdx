...
| **C1** | Runtime residual (first-party fixtures; no third-party corpus shipped) | P1 | ⚙️ ongoing |
...
- **Runtime residual (C1):** tracked on first-party fixtures; third-party corpora are not shipped.
