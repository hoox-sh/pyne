...
<CardGroup cols={3}>
  ...
  <Card title="Missing features" icon="list" href="/pyne/docs/pynets/missing-features">
    Builtin and host gaps versus Python. Drawings, strategy fields, compile lag.
  </Card>
...
- [Missing features](/pyne/docs/pynets/missing-features)
