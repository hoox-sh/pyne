...
| `POST` | `/scripts` · `/cron/*` | optional runner | Hosted scripts + bar-close — **off** unless `PYNE_RUNNER=1` ([runner](/pyne/docs/api/endpoints/runner)) |
...
3. [Run](/pyne/docs/api/endpoints/run) · [Optimize](/pyne/docs/api/endpoints/optimize) · [Preview](/pyne/docs/api/endpoints/preview) · [Backtest](/pyne/docs/api/endpoints/backtest)
