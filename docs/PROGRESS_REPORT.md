...
### 🎯 Overall Progress: Strong parser + solid evaluator coverage (tests: **2474** collected, 0.3.17)
...
| **Compile** | Good | Numba + object-mode; **0.3.16–0.3.17** UDT/switch/matrix/drawing/round/color residuals |
